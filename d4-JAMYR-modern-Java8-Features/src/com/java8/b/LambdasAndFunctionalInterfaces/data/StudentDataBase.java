...
//		List<Student> students = Arrays.asList(student1, student2, student3, student4, student5, student6, null); //Tener cuidado, podria afectar otras clases que llaman esta lista
		return students;
	}
	
	public static List<Student> getAllStudentsWithNullLast(){ //No funciona
		List<Student> studentList = getAllStudents();
		
		studentList.add(studentList.size(), null);
